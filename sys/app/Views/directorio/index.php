...
<?php if (isset($from) && $from == 'Directorio/misDirectorios/') : ?>
    <div class="row">
        <div class="col-md-3">
            ...
            <article id="Directorio" id_directorio="<?php echo $directorio['entr_id'] ?>">
                <div class="d-flex align-items-start">
                    <div class="d-flex flex-column">
                        ...
                        <?php if (isset($misdirectorios) && in_array((object)["entr_id" => $directorio['entr_id']], $misdirectorios)) : ?>
                            <a href="<?php echo base_url('Directorio/editar/' . $directorio['entr_id']) ?>" id="editar" class="mt-auto btn btn-sm btn-outline-secondary">editar</a>
                    ...
                    <div class="w-100 ms-3">
                        <div class="row">
                            <div class="col-md-2">
                                <a href="<?php echo $directorio['entr_url'] ?>">
                            ...
                            <div class="col-md-9">
                                ...
                                <p>
                                    ...
                                    <br>
                                    <a class="<?php echo $directorio['entr_url'] ?>" href="<?php echo $directorio['entr_url'] ?>">Más</a>
                                </p>
                                <small>
