...
<ul class="list-group">
    ...
    <a href="<?php echo base_url('Noticias/misNoticias/') ?>" class="list-group-item list-group-item-action <?php echo (isset($from) && $from == 'Noticias/misNoticias/') ? 'active' : '' ?>">Mis noticias</a>
