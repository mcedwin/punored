...
$(document).ready(function() {
    ...
    function botones(data, $ar) {
        ...
        <a class="btn btn-secondary btn-sm" href="{baseurl}solicitud/ver/{id}"><i class="fas fa-eye"></i></a>
        <a class="btn btn-success edit btn-sm" href="{baseurl}solicitud/edit/{id}"><i class="fas fa-edit"></i></a>
        <a class="btn btn-danger delete btn-sm" href="{baseurl}solicitud/delete/{id}"><i class="fas fa-trash-alt"></i></a></td>
        </div>`;
